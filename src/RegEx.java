...
class RegExTree {
  ...
  public static RegExTree cloneTree(RegExTree ret) {
    if (ret==null) return null;
    ArrayList<RegExTree> cloneSubTrees = new ArrayList<>();
    for (RegExTree reg: ret.subTrees) cloneSubTrees.add(cloneTree(reg));
    RegExTree copy = new RegExTree(ret.root, cloneSubTrees);
    return copy;
  }
  @Override
  protected Object clone() throws CloneNotSupportedException { return cloneTree(this); }
}
